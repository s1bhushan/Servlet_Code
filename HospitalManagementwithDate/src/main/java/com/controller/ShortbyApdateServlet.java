...
@WebServlet("/ShortbyApdateServlet")
public class ShortbyApdateServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	public ShortbyApdateServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		List<Hospital> listHos = dao.shortApdateAllPatient();
