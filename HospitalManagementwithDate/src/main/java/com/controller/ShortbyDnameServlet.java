...
@WebServlet("/ShortbyDnameServlet")
public class ShortbyDnameServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	public ShortbyDnameServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		List<Hospital> listHos = dao.shortDnameAllPatient();
