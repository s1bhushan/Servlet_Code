...
@WebServlet("/ShortbyPnameServlet")
public class ShortbyPnameServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	public ShortbyPnameServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		List <Hospital> listHos=dao.shortPnameAllPatient();
